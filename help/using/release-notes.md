...
Versionsinformationen för den senaste versionen av datorprogrammet, version 2.3.3, visas nedan. Lanseringsdatumet är 16 maj 2025.
...
* När du överför ändringar till en resurs med kommentarer lagras kommentarerna med resursen i [!DNL Experience Manager], men de visas inte som versionskommentarer. Problemet har lösts i [!DNL Experience Manager] 6.4.5 och [!DNL Experience Manager] 6.5.1. Adobe rekommenderar att du installerar de senaste servicepaketen. <!-- CQ-4268990 -->
