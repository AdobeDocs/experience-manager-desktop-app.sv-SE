...
description: Viktiga funktioner och rekommenderade [!DNL Adobe Experience Manager] datorprogram version 1.10.
...
[!DNL Adobe Experience Manager] datorprogrammet länkar din DAM-lösning (Digital Asset Management) till skrivbordet så att du kan öppna de filer som finns i AEM webbgränssnitt direkt på skrivbordet. Om du har sparat en resurs från skrivbordet överförs den till AEM på lämplig plats.
...
>[!NOTE]
>
>Innan du läser det här dokumentet kan du granska det övergripande [Bästa praxis för integrering av AEM och Creative Cloud](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/administer/aem-cc-integration-best-practices) för en översikt över ämnet på högre nivå.
...
* **Överför stora, hierarkiska mappar i grupp**. Om du använder **Skapa** > **Mappöverföring** om du AEM överför resurser i användargränssnittet överför det AEM datorprogrammet den valda mapphierarkin till AEM i bakgrunden. Överföringsförloppet övervakas med ett dedikerat användargränssnitt i skrivbordsappen.
...
* Använd inte AEM datorprogram för att migrera stora mängder data från en AEM till en annan. Se [Migreringshandbok](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/administer/assets-migration-guide) för att planera och utföra resursmigreringar. Datorprogrammet [stöder massöverföring](use-app-v1.md#bulkupload) stort antal resurser för första gången i [!DNL Adobe Experience Manager].
...
* För **mindre uppdateringar**, t.ex. mindre retuscheringsbegäranden i godkännandeprocessen:
...
Om du vill veta mer om de bästa sätten att konfigurera AEM Assets-nätverk går du till [Så här migrerar du resurser satsvis](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/administer/assets-migration-guide) -dokument. Några av de viktiga aspekter som hjälper användarna att optimera upplevelsen av AEM program är:

* **Använd en korrekt konfigurerad Dispatcher**. Använd AEM Dispatcher för ytterligare säkerhet och kontrollera att den är konfigurerad för [AEM anslutning till datorprogram AEM bakom Dispatcher](install-configure-app-v1.md#connect-to-an-aem-instance-behind-a-dispatcher)
...
* **Uppladdning av resurser med högre prestanda**. Konfigurera [Arbetsflödesmodellen AEM tillgångsuppdatering ska vara övergående](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/administer/performance-tuning-guidelines).
